...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  @NonNull
  public final AutoCompleteTextView acAddStop;
  ...
  private FragmentFavoritesBinding(@NonNull LinearLayout rootView,
      @NonNull AutoCompleteTextView acAddStop, @NonNull RecyclerView rvFavorites,
      @NonNull LinearLayout tvEmpty) {
    this.rootView = rootView;
    this.acAddStop = acAddStop;
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.ac_add_stop;
      AutoCompleteTextView acAddStop = ViewBindings.findChildViewById(rootView, id);
      if (acAddStop == null) {
        break missingId;
      }
      ...
      return new FragmentFavoritesBinding((LinearLayout) rootView, acAddStop, rvFavorites, tvEmpty);
    }
